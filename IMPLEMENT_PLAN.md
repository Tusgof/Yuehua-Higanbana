...
- **Immediate next safe action**: Continue P0 with evidence-tier policy/enforcement (P0.4), then add the read-only project-state reporter (P0.6). Do not buy data yet.
