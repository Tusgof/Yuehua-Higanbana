...
- Next real experiment research log is `011-higanbana-...`.
...
| H-A2.2 | Re-analyze the existing M5.5 macro-filter result as H-A2 E1 evidence with inherited 9-trial search contamination and DSR blocker/adjustment | M | RISK | New summary/report cites the 9 M5.5 trials and does not claim E2 |
...
| H-A2.6 | Write research log `011-higanbana-...` only if a real experiment or formal deferred/falsification result completes | S | OK | `python scripts\audit_research_logs.py` passes and next prefix advances |
...
- **Immediate next safe action**: Start H-A2 with a pre-registered re-analysis of the existing M5.5 macro-filter result as E1 evidence, including inherited 9-trial search contamination and DSR blocker/adjustment. Do not buy data yet.
