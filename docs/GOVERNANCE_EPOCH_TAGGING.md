...
The controlling machine-readable record is `config\governance_epochs.json`. Git tags may be added later for convenience, but the manifest is the audit source because it can be validated in the hermetic tier.
