# H-A2 Normal/Control Exact Replay Preregistration
...
- **Created**: 2026-07-07
- **Controlling JSON**: `experiments/h_a2_normal_control_exact_replay_preregistration.json`

## Why This Exists
H-A2.48 showed that the normal/control data pack can be read locally and that the locked H-A2 signal has exactly one candidate-ready date: `2025-02-11`.
...
python -m unittest tests.test_validate_h_a2_normal_control_exact_replay_preregistration
```
