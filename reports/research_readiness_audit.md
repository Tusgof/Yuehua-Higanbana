...
- H-A2 fresh OOS checkpoint is complete as E1 methodology-failure evidence. The prior threshold-0.001 branch is lookahead-contaminated because its selection feature used the 15:45 close while being described as 09:35-known; do not reuse that branch for edge or deployment claims. The replacement run found 6 retrospective candidates from 20 dates, but the 09:35 bar close is available around 09:36 while entry option quotes are stamped 09:35. Mechanical PnL, PSR, and MinTRL are invalid for inference. H-A2 remains active but the exact 09:35 question is unanswered. Stop expansion and pre-register an observable 09:35 rule or explicit 09:36 rule on untouched outcomes; do not approve E2, paper trading, operational validation, or real-money trading.
