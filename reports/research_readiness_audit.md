...
- H-A2.66 October 2022 exact stress replay is complete as E1 diagnostic evidence: 13/13 dates pass SPY bar coverage, but all dates fail the ex-ante clean macro/VIX gate, leaving 0 candidate trades. The minimum-2 trade-density checkpoint failed, so stop without the contingent September purchase. This stress block cannot identify the locked clean-regime rule; next revisit hypothesis/regime alignment before any new data decision. Do not approve paper trading, operational validation, real-money trading, or claim E2 from this zero-trade result.
