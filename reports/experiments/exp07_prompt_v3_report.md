...
- Stable cases across prompts: 6 / 9
- Expected-decision mismatches: 0
- Input archive: `reports\experiments\exp07_prompt_v3_inputs.json`
- Assessment JSONL: `reports\experiments\exp07_prompt_v3_assessments.jsonl`
