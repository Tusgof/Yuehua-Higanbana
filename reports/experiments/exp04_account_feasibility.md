# รายงานการทดลอง exp04_account_feasibility

## สมมติฐาน
A $1,000 cash account can only trade structures whose defined max loss fits tested sizing constraints.

## หลักฐานที่ใช้
- Evidence type: fixture / synthetic smoke test
- Train window: 2022-05-11 to 2023-12-31
- OOS window: 2024-01-01 to 2026-06-29
- Chart: `D:\Fogust\Workspace\Investment\Project\SPY 0DTE - Higanbana\reports\experiments\charts\exp04_account_feasibility_equity.svg`

![equity curve](D:\Fogust\Workspace\Investment\Project\SPY 0DTE - Higanbana\reports\experiments\charts\exp04_account_feasibility_equity.svg)
