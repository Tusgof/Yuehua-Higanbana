...
- Stable cases across prompts: 43 / 43
- Guarded stable cases across prompts: 43 / 43
- Expected-decision mismatches: 18
- Unknown-policy violations: 45
- Guarded unknown-policy violations: 0
- Input archive: `reports\experiments\exp07_prompt_v12_inputs.json`
- Assessment JSONL: `reports\experiments\exp07_prompt_v12_assessments_dryrun.jsonl`
...
| `high_vol_no_clear_news_vix27` | `unknown` | `allow` | `unknown` | `True` | `True` |
| `major_fed_event_vix21` | `unknown` | `allow` | `unknown` | `True` | `True` |
| `cpi_release_pending_vix22` | `unknown` | `allow` | `unknown` | `True` | `True` |
| `jobs_report_pending_vix19` | `unknown` | `allow` | `unknown` | `True` | `True` |
| `earnings_heavy_calendar_vix20` | `unknown` | `allow` | `unknown` | `True` | `True` |
| `pce_inflation_pending_vix18` | `unknown` | `allow` | `unknown` | `True` | `True` |
| `high_vol_no_news_vix26` | `unknown` | `allow` | `unknown` | `True` | `True` |
...
| `treasury_auction_pending_vix18` | `unknown` | `allow` | `unknown` | `True` | `True` |
| `earnings_after_close_vix16` | `allow` | `allow` | `allow` | `True` | `True` |
| `cpi_tomorrow_vix16` | `allow` | `allow` | `allow` | `True` | `True` |
| `cpi_next_week_fed_today_vix19` | `unknown` | `allow` | `unknown` | `True` | `True` |
| `stress_contained_vix18` | `allow` | `allow` | `allow` | `True` | `True` |
| `panic_bid_defensives_vix17` | `allow` | `block` | `allow` | `True` | `True` |
...
| `emergency_drill_vix14` | `allow` | `block` | `allow` | `True` | `True` |
| `single_stock_halt_after_close_vix16` | `allow` | `allow` | `allow` | `True` | `True` |
| `bank_stress_contained_fed_today_vix21` | `unknown` | `allow` | `unknown` | `True` | `True` |
| `banking_stress_spreads_systemic_vix24` | `block` | `block` | `block` | `True` | `True` |
| `futures_halt_rumor_vix29` | `block` | `allow` | `block` | `True` | `True` |
| `cpi_today_earnings_next_month_vix18` | `unknown` | `allow` | `unknown` | `True` | `True` |
...
| `vix_vxv_inversion_vix24` | `unknown` | `allow` | `unknown` | `True` | `True` |
| `normal_vix24_vxv25_no_news` | `allow` | `allow` | `allow` | `True` | `True` |
| `spy_etf_halt_risk_vix23` | `block` | `allow` | `block` | `True` | `True` |
| `ism_services_today_vix18` | `unknown` | `allow` | `unknown` | `True` | `True` |
| `jolts_today_vix18` | `unknown` | `allow` | `unknown` | `True` | `True` |
| `retail_sales_today_vix18` | `unknown` | `allow` | `unknown` | `True` | `True` |
| `no_war_risk_eased_vix17` | `allow` | `block` | `allow` | `True` | `True` |
...
| `circuit_breaker_risk_vix24` | `block` | `allow` | `block` | `True` | `True` |
