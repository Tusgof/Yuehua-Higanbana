# รายงานการทดลอง exp07_cost_latency

## สมมติฐาน
The LLM gate needs a stable prompt variant before strategy use; full-spread execution and latency of 2 minutes or more erase the system edge.

## หลักฐานที่ใช้
- Evidence type: fixture / synthetic smoke test
- Train window: 2022-05-11 to 2023-12-31
- OOS window: 2024-01-01 to 2026-06-29
- Chart: `D:\Fogust\Workspace\Investment\Project\SPY 0DTE - Higanbana\reports\experiments\charts\exp07_cost_latency_equity.svg`

![equity curve](D:\Fogust\Workspace\Investment\Project\SPY 0DTE - Higanbana\reports\experiments\charts\exp07_cost_latency_equity.svg)
