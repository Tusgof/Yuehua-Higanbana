...
- Stable cases across prompts: 24 / 35
- Guarded stable cases across prompts: 35 / 35
- Expected-decision mismatches: 1
- Unknown-policy violations: 14
- Guarded unknown-policy violations: 0
- Input archive: `reports\experiments\exp07_prompt_v11_inputs.json`
- Assessment JSONL: `reports\experiments\exp07_prompt_v11_assessments.jsonl`
...
| `high_vol_no_news_vix26` | `unknown` | `unknown` | `unknown` | `True` | `True` |
...
| `cpi_next_week_fed_today_vix19` | `unknown` | `allow, unknown` | `unknown` | `False` | `True` |
| `stress_contained_vix18` | `allow` | `allow` | `allow` | `True` | `True` |
| `panic_bid_defensives_vix17` | `allow` | `allow, unknown` | `allow` | `False` | `True` |
