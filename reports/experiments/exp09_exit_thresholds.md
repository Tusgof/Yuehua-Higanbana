# รายงานการทดลอง exp09_exit_thresholds

## สมมติฐาน
The baseline Sub-System A 25/50 exit and conservative Sub-System B stop rules improve net PnL and tail risk.

## หลักฐานที่ใช้
- Evidence type: fixture / synthetic smoke test
- Train window: 2022-05-11 to 2023-12-31
- OOS window: 2024-01-01 to 2026-06-29
- Chart: `D:\Fogust\Workspace\Investment\Project\SPY 0DTE - Higanbana\reports\experiments\charts\exp09_exit_thresholds_equity.svg`

![equity curve](D:\Fogust\Workspace\Investment\Project\SPY 0DTE - Higanbana\reports\experiments\charts\exp09_exit_thresholds_equity.svg)
