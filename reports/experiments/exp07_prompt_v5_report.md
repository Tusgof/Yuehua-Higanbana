...
- Unknown-policy violations: 2
- Input archive: `reports\experiments\exp07_prompt_v5_inputs.json`
- Assessment JSONL: `reports\experiments\exp07_prompt_v5_assessments.jsonl`
...
| `cpi_release_pending_vix22` | `unknown` | `unknown` | `True` |
