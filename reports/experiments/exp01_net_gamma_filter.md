# รายงานการทดลอง exp01_net_gamma_filter

## สมมติฐาน
Market-maker net gamma/NOVI filtering improves risk-adjusted performance by reducing false ORB breakouts and ratio-spread tail losses.

## หลักฐานที่ใช้
- Evidence type: fixture / synthetic smoke test
- Train window: 2022-05-11 to 2023-12-31
- OOS window: 2024-01-01 to 2026-06-29
- Chart: `D:\Fogust\Workspace\Investment\Project\SPY 0DTE - Higanbana\reports\experiments\charts\exp01_net_gamma_filter_equity.svg`

![equity curve](D:\Fogust\Workspace\Investment\Project\SPY 0DTE - Higanbana\reports\experiments\charts\exp01_net_gamma_filter_equity.svg)
