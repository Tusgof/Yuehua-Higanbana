...
- **Mode**: `live`
- **Total request count**: 28
- **Total estimated cost**: `$0.819428`
- **Decision**: `pass`
- **Decision reason**: Estimated cost $0.819428 is below review threshold $5.0.

## Scenario Summary

| Scenario | Requests | First Start UTC | Last End UTC | Dataset | Schema | Symbol |
|:--|--:|:--|:--|:--|:--|:--|
| `oos_2024_08_intraday_exit_30m_chunk1` | 28 | `2024-08-01T13:30:00+00:00` | `2024-08-02T19:50:00+00:00` | `OPRA.PILLAR` | `cbbo-1m` | `SPY.OPT` |
