...
- **Total estimated cost**: `$0.337333`
- **Decision**: `pass`
- **Decision reason**: Estimated cost $0.337333 is below review threshold $5.0.

## Scenario Summary

| Scenario | Requests | First Start UTC | Last End UTC | Dataset | Schema | Symbol |
|:--|--:|:--|:--|:--|:--|:--|
| `insample_2023_12_sample` | 14 | `2023-12-01T14:30:00+00:00` | `2023-12-01T20:50:00+00:00` | `OPRA.PILLAR` | `cbbo-1m` | `SPY.OPT` |
