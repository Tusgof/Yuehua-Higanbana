...
- **Source report**: `reports\data_cost\databento_cost_insample_2023_12_intraday_exit_30m_sample.json`
- **Source scenario**: `insample_2023_12_sample`
- **Source mode**: `live`
- **Source successful request count**: 14
- **Source error count**: 0
- **Average cost per research window**: `$0.02409524`

## Projection

| Scenario | Requests | Projected Cost USD |
|:--|--:|--:|
| `insample_2023_12` | 280 | `$6.746668` |
