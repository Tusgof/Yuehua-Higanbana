...
- **Total estimated cost**: `$1.994316`
- **Decision**: `pass`
- **Decision reason**: Estimated cost $1.994316 is below review threshold $5.0.

## Scenario Summary

| Scenario | Requests | First Start UTC | Last End UTC | Dataset | Schema | Symbol |
|:--|--:|:--|:--|:--|:--|:--|
| `oos_2024_08_intraday_exit_30m_chunk5` | 70 | `2024-08-26T13:30:00+00:00` | `2024-08-30T19:50:00+00:00` | `OPRA.PILLAR` | `cbbo-1m` | `SPY.OPT` |
