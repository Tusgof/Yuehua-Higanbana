...
- **Total estimated cost**: `$1.501495`
- **Decision**: `pass`
- **Decision reason**: Estimated cost $1.501495 is below review threshold $5.0.

## Scenario Summary

| Scenario | Requests | First Start UTC | Last End UTC | Dataset | Schema | Symbol |
|:--|--:|:--|:--|:--|:--|:--|
| `oos_2024_05_intraday_exit_30m_chunk5` | 56 | `2024-05-28T13:30:00+00:00` | `2024-05-31T19:50:00+00:00` | `OPRA.PILLAR` | `cbbo-1m` | `SPY.OPT` |
