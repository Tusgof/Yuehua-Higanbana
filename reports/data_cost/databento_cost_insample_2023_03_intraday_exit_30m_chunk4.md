...
- **Total estimated cost**: `$1.637277`
- **Decision**: `pass`
- **Decision reason**: Estimated cost $1.637277 is below review threshold $10.0.

## Scenario Summary

| Scenario | Requests | First Start UTC | Last End UTC | Dataset | Schema | Symbol |
|:--|--:|:--|:--|:--|:--|:--|
| `insample_2023_03` | 70 | `2023-03-20T13:30:00+00:00` | `2023-03-24T19:50:00+00:00` | `OPRA.PILLAR` | `cbbo-1m` | `SPY.OPT` |
