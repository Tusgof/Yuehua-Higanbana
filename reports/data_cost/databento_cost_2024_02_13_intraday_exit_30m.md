...
- **Total estimated cost**: `$0.358536`
- **Decision**: `pass`
- **Decision reason**: Estimated cost $0.358536 is below review threshold $5.0.

## Scenario Summary

| Scenario | Requests | First Start UTC | Last End UTC | Dataset | Schema | Symbol |
|:--|--:|:--|:--|:--|:--|:--|
| `one_day_sample` | 14 | `2024-02-13T14:30:00+00:00` | `2024-02-13T20:50:00+00:00` | `OPRA.PILLAR` | `cbbo-1m` | `SPY.OPT` |
