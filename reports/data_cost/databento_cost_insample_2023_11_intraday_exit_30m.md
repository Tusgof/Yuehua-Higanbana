...
- **Total estimated cost**: `$6.722094`
- **Decision**: `review`
- **Decision reason**: Estimated cost $6.722094 is at or above review threshold $5.0.

## Scenario Summary

| Scenario | Requests | First Start UTC | Last End UTC | Dataset | Schema | Symbol |
|:--|--:|:--|:--|:--|:--|:--|
| `insample_2023_11` | 294 | `2023-11-01T13:30:00+00:00` | `2023-11-30T20:50:00+00:00` | `OPRA.PILLAR` | `cbbo-1m` | `SPY.OPT` |
