...
- **Mode**: `live`
- **Total request count**: 63
- **Total estimated cost**: `$1.483808`
- **Decision**: `pass`
- **Decision reason**: Estimated cost $1.483808 is below review threshold $5.0.

## Scenario Summary

| Scenario | Requests | First Start UTC | Last End UTC | Dataset | Schema | Symbol |
|:--|--:|:--|:--|:--|:--|:--|
| `one_month_pilot` | 63 | `2024-01-02T14:30:00+00:00` | `2024-01-31T20:50:00+00:00` | `OPRA.PILLAR` | `cbbo-1m` | `SPY.OPT` |
