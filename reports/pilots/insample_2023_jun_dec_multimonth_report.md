...
## สถานะ
- Split: `in_sample`
- ช่วงข้อมูล: `2023-06-01` ถึง `2023-12-29`
...
```json
{
  "average_net_pnl": 20.1212,
  "best_trade": 170.0,
  "candidate_days": 34,
  "closed_trades": 33,
  "exit_model": "forced_close_only",
  "max_drawdown": -0.149351,
  "sharpe_proxy": 0.285121,
  "skipped_trades": 1,
  "status_counts": {
    "closed_forced_1545": 33,
    "missing_quotes": 1
  },
  "total_net_pnl": 664.0,
  "win_rate": 0.3939,
...
```json
{
  "average_net_pnl": -1.1176,
  "best_trade": 27.0,
  "candidate_days": 34,
  "closed_trades": 34,
  "exit_model": "target_stop_25_50",
  "max_drawdown": -0.071,
  "sharpe_proxy": -0.07088,
  "skipped_trades": 0,
  "status_counts": {
    "closed_profit_target_25pct": 19,
