...
```json
{
  "average_net_pnl": -1.06,
  "best_trade": 15.44,
  "candidate_days": 6,
  "closed_trades": 6,
  "max_drawdown": -0.048516,
  "sharpe_proxy": -0.062835,
  "skipped_trades": 0,
  "total_cost_drag": 27.36,
  "total_implementable_pnl": -6.36,
  "total_mid_pnl": 21.0,
  "win_rate": 0.6667,
  "worst_trade": -25.56
}
...
```json
{
  ...
  "original_sharpe_proxy": -0.062835,
  "original_total_implementable_pnl": -6.36,
  "removed_each_side": 1,
  "removed_trade_count": 2,
  "retained_closed_trades": 4,
  "retained_sharpe_proxy": 0.065693,
  "retained_total_implementable_pnl": 3.76,
  "status": "pass"
}
```
