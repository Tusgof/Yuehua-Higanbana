...
class AuditResearchLogsTests(unittest.TestCase):
    ...
    def test_current_research_logs_are_present_and_pushed(self) -> None:
        ...
        self.assertEqual(10, len(result["required_logs"]))
        ...
        self.assertEqual("011", result["sequence"]["next_log_number"])
        self.assertEqual("011-higanbana-", result["sequence"]["next_filename_prefix"])
