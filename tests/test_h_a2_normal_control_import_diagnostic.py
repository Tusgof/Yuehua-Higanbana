...
from scripts.validate_h_a2_normal_control_import_diagnostic import (
    DEFAULT_SUMMARY_PATH,
    validate_h_a2_normal_control_import_diagnostic,
)


class H_A2NormalControlImportDiagnosticTests(unittest.TestCase):
    def test_current_summary_validates(self) -> None:
        ...
        result = validate_h_a2_normal_control_import_diagnostic()
    ...
    def _validate_temp(payload: dict) -> dict:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            return validate_h_a2_normal_control_import_diagnostic(path)
