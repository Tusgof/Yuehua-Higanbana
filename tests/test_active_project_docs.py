...
class ActiveProjectDocsTests(unittest.TestCase):
    def test_active_docs_exist(self) -> None:
        required = [
            ...
            "scripts/report_project_state.py",
            ...
            "reports/hypothesis_registry_audit.md",
            "reports/hypothesis_registry_audit.json",
            "reports/evidence_tier_audit.md",
            "reports/evidence_tier_audit.json",
